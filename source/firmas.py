...
class BaseFirmas:
    ...
    def agregar_firma_hash(self, hash_archivo: str, firma: FirmaMalware):
        self.firmas_por_hash[hash_archivo] = firma

    def agregar_firma_patron(self, patron: str, firma: FirmaMalware):
        self.firmas_por_patron[patron] = firma

    def buscar_por_hash(self, hash_archivo: str):
        return self.firmas_por_hash.get(hash_archivo)

    def buscar_patron_en_contenido(self, contenido: str):
        ...
        # Peor caso: O(p * m), donde p es el número de patrones y m el tamaño del archivo.
